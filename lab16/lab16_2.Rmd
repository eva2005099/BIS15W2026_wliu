...
```{r}
genome01_blastn <- read_csv("~/Desktop/BIS15W2026_wliu/lab16/blast_results/genome01_blastn.csv")
```
...
```{r}
  readDNAStringSet("data/e.coli_genbank.fasta")
```

Lets look at the head of the fasta file
```{r}
aa_file <- readAAStringSet()
```
