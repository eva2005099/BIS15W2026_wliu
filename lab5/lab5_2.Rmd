...
```{r}
filter(penguins,body_mass_g%in%c(5400,5350,5250,5300,5500,5450))
```
...
```{r}
setwd("/Users/eva2005/Desktop/BIS15W2026_wliu/lab5/data")
```
...
```{r}
filter(penguins,body_mass_g>5000 | bill_depth_mm>18)
```
...
```{r}
fish%>%
  select(fish_id,radii_length_mm)%>%
  filter(lakeid=="AL"|lakeid=="AR") %>%
  filter(between(radii_length_mm))
```
